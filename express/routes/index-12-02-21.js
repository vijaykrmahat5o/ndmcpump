...
"CASE WHEN drd.meter_phase_type IS NOT NULL THEN drd.amp_r/100 ELSE if(drd.output_status=0 AND (drd.amp_r/1000 < 2.3), if(drd.voltage_r < 8000,0,drd.amp_r/1000), drd.amp_r/1000)) END, "+
"CASE WHEN drd.meter_phase_type IS NOT NULL THEN drd.amp_y/100 ELSE if(drd.output_status=0 AND (drd.amp_y/1000 < 2.3), if(drd.voltage_y < 8000,0,drd.amp_y/1000), drd.amp_y/1000)) END, "+
"CASE WHEN drd.meter_phase_type IS NOT NULL THEN drd.amp_b/100 ELSE if(drd.output_status=0 AND (drd.amp_b/1000 < 2.3), if(drd.voltage_b < 8000,0,drd.amp_b/1000), drd.amp_b/1000)) END, "+
"CASE WHEN drd.meter_phase_type IS NOT NULL THEN drd.kw_r/1000 ELSE if(drd.output_status=0 AND (drd.amp_r/1000 < 2.3 OR drd.amp_y/1000 < 2.3 OR drd.amp_b/1000 < 2.3), if(drd.voltage_r < 8000,0,drd.kw_r/100000), drd.kw_r/100000)) END, "+
"CASE WHEN drd.meter_phase_type IS NOT NULL THEN drd.kw_y/1000 ELSE if(drd.output_status=0 AND (drd.amp_r/1000 < 2.3 OR drd.amp_y/1000 < 2.3 OR drd.amp_b/1000 < 2.3), if(drd.voltage_y < 8000,0,drd.kw_y/100000), drd.kw_y/100000)) END, "+
"CASE WHEN drd.meter_phase_type IS NOT NULL THEN drd.kw_b/1000 ELSE if(drd.output_status=0 AND (drd.amp_r/1000 < 2.3 OR drd.amp_y/1000 < 2.3 OR drd.amp_b/1000 < 2.3), if(drd.voltage_b < 8000,0,drd.kw_b/100000), drd.kw_b/100000)) END, "+
"drd.kwh/100, "+
