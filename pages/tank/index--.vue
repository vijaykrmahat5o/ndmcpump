    ...
    <div class="flex-grow-1" style="margin-top:75px">
        <b-container fluid class="min-h-screen">
            <div class="">
                ...
                <b-row class="px-2">
                    <b-col class="px-2">
                        <b-card img-alt="Card image" img-left class="info-box mb-3">
                            ...
                            <img class="card-img" src="/level.png"/>
                        </b-card>
                    </b-col>
                    <b-col class="px-2">
                        <b-card img-alt="Card image" img-left class="info-box mb-3">
                ...
                <b-row class="px-2">
                    <b-col class="px-2">
                        <b-card img-alt="Card image" img-left class="info-box mb-3">
                            <h2>Pumps Monitoring</h2>
                                <center>
                                    <NuxtLink :to="'/dashboard/farrukhabad'" class="nav-link">
                                        <b-button>
                    ...
                    <b-col class="px-2">
                        <b-card img-alt="Card image" img-left class="info-box mb-3">
                            <h2>Tank Level</h2>
                                <center>
                                    <NuxtLink :to="'/tanks/farrukhabad'" class="nav-link">
                                        <b-button>
                ...
                <b-row class="px-3">
                    <b-card>
                        <GmapMap :center="{lat:center.lat, lng:center.lng}" :zoom="16" map-type-id="terrain" style="width: 100%; height: 500px">
                            <GmapInfoWindow :options="infoOptions" :position="infoWindowPos" :opened="infoWindowOpen" @closeclick="infoWindowOpen=false"></GmapInfoWindow>
                            <GmapMarker :key="index" v-for="(m, index) in markers" :position="m.position" :clickable="true"  @click="toogleMarkerInfoWindow(m,index)" :draggable="false" :icon="m.icon"/>
                            <GmapCluster :gridSize="10" :position="center" :averageCenter="true">
                                <GmapMarker :key="index" v-for="(m, index) in markers" :position="m.position" :clickable="false" :icon="m.icon" @click="toogleMarkerInfoWindow(m,index)"></GmapMarker>
                            </GmapCluster>
                        </GmapMap>
                    </b-card>
                </b-row>
