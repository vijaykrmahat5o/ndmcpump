<template>
    <div class="flex-grow-1" style="margin-top:75px">
                ...
                <b-row class="pb-3">
                    <b-col cols="12" class="text-center">
                        ...
                        <!--<b-breadcrumb class="mb-0">
                            ...
                            <b-breadcrumb-item active>{{zone.title}}</b-breadcrumb-item>
                        </b-breadcrumb>-->
                    </b-col>
        ...
        <b-modal id="edit-model" :title="(selectedItem.id > 0)?'Edit Pump':'Add Pump'" size="lg" ok-only @hidden="resetSelectedItem" @ok="modalSubmit">
			<b-container fluid>
				<b-row class="mb-1">
					<b-col>
                        ...
                        var conn_status = 1;
                            ...
                            for (var i = 0; i < self.devices.length; i++) {
                                ...
                                if(d.latitude != 'NaN' && d.latitude != 'undefined' && d.latitude != ''){
                                    ...
                                    var msg = '<b>FP No: '+d.feeder_piller_no+'</b><br><b>Location</b> : '+d.location+'<br><b>Latitude :</b> '+d.latitude+'<br><b>Longitude :</b> '+d.longitude+'<br><b>Water Level :</b> '+((d.analoginput/100).toFixed(2)) * 10+'<br><b>Last Updated Time :</b> '+self.$moment(d.update_time).format('DD-MM-YYYY HH:mm:ss');
